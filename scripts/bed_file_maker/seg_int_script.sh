...
# Input file
input="/home/ceglab5/Desktop/simulations/src2/lcr_400/output_appended2_seg_intermediate_output.txt"

# Output file
output="/home/ceglab5/Desktop/simulations/src2/lcr_400/seg_i_coords"
...
while IFS= read -r line; do
    if [[ $line == ">"* ]]; then
        ...
        if [[ $line =~ [a-z] ]]; then
            ...
            echo -e "${protein_name}\t${start_pos}\t${end_pos}" | awk 'NF==3' | sed 's/>//g' >> "$output"
        fi
    fi
done < "$input"
