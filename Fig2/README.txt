...
The folder “multiinter” contains the bed files of the LCRs predicted by various methods (ending with .bed). It also has the files containing LCRs detected by “n” number of methods, their sequences (files ending with “_gf”), their peptide counts (files ending with “_gf_peptide_counts”) and their entropy and purity (files ending with “_gf_entropy_purity”). 
